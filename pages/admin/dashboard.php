...
const AdminApp=()=>{
  ...
  const nav=[{id:'dashboard',ico:'📊',lbl:'Dashboard'},{id:'usuarios',ico:'👥',lbl:'Usuarios'},{id:'materias',ico:'📚',lbl:'Materias'},{id:'inscripciones',ico:'📋',lbl:'Inscripciones'},{id:'reportes',ico:'📈',lbl:'Reportes'}];
  const vistas={dashboard:<Dashboard/>,usuarios:<Usuarios/>,materias:<Materias/>,inscripciones:<Inscripciones/>,reportes:<Reportes/>};
  ...
  return<>
    ...
    <header className="topbar">
      ...
      <div className="tb-right">
        ...
        <div className="tb-notif"><span>🔔</span><div className="tb-notif-dot"/></div>
      </div>
    </header>
    {/* Contenido */}
